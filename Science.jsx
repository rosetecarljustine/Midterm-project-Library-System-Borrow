...
const isScienceBook = scienceBooks.some(
  b => b.title === selectedBook?.title
);

const defaultBook = isScienceBook
  ? selectedBook
  : scienceBooks[0];
...
const [carouselBooks, setCarouselBooks] = useState(
  scienceBooks.filter(b => b.title !== defaultBook.title)
);
          ...
          <div className="top-section-page">
                ...
                <p className="type-page">
                  <strong>Type:</strong>{" "}
                    <span
                      ...
                      style={{
                      backgroundColor:
                      typeColors[currentBook?.type] || "#ccc"
                      }}
                    >
            ...
            <div className="bottom-right-page">
                <div className="carousel-page">
                  <h2 className="h2-page">Other Science Books</h2>

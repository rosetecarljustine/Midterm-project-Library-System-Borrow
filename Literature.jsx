...
const isLiteratureBook = literatureBooks.some(
  b => b.title === selectedBook?.title
);

const defaultBook = isLiteratureBook
  ? selectedBook
  : literatureBooks[0];
...
const [carouselBooks, setCarouselBooks] = useState(
  literatureBooks.filter(b => b.title !== defaultBook.title)
);

...
const isTechnologyBooks = technologyBooks.some(
  b => b.title === selectedBook?.title
);

const defaultBook = isTechnologyBooks
  ? selectedBook
  : technologyBooks[0];
...
const [carouselBooks, setCarouselBooks] = useState(
  technologyBooks.filter(b => b.title !== defaultBook.title)
);
